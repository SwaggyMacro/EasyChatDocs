...
<Cards>
  <Card title="Audio Translation" icon={<Speech />} href="./simultaneous-interpretation/asr">
    EasyChat recognizes audio and video playing on your system, then displays the translated result as subtitles.
  </Card>

  <Card title="Live Interpretation" icon={<MicSignal />} href="./simultaneous-interpretation/speak">
